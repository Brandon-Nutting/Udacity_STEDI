...
AccelerometerTrustedZone_node1688102900198 = (
    glueContext.create_dynamic_frame.from_options(
        ...
        format="json",
        connection_options={
            "paths": ["s3://udacity-bucket-example-course/accelerometer/trusted/"],
            "recurse": True,
        },
...
CustomerTrustedZone_node1688782334053 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://udacity-bucket-example-course/Customer/trusted/"],
        "recurse": True,
    },
...
StepTrainerTrustedZone_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://udacity-bucket-example-course/step_trainer/trusted/"],
        "recurse": True,
    },
...
RenamedkeysforJoin_node1688782409638 = ApplyMapping.apply(
    ...
    mappings=[
        ...
        ("registrationDate", "bigint", "right_registrationDate", "long"),
        (
        ...
        ("lastUpdateDate", "bigint", "right_lastUpdateDate", "long"),
...
JoinStepTrainer_node1688103008151 = Join.apply(
    ...
    keys2=["sensorReadingTime", "right_email"],
...
MachineLearningZone_node3 = glueContext.getSink(
    path="s3://udacity-bucket-example-course/step_trainer/ml_curated/",
    connection_type="s3",
    updateBehavior="LOG",
    partitionKeys=[],
...
MachineLearningZone_node3.setCatalogInfo(
    catalogDatabase="test", catalogTableName="ml_curated"
)
