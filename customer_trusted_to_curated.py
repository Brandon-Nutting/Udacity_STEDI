...
DropDuplicates_node1704321096523 = DynamicFrame.fromDF(
    DropFields_node1704319572027.toDF().dropDuplicates(),
    glueContext,
    "DropDuplicates_node1704321096523",
)

# Script generated for node Customer Curated
CustomerCurated_node1704319136579 = glueContext.write_dynamic_frame.from_options(
    frame=DropDuplicates_node1704321096523,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://udacity-bucket-example-course/customer/curated/",
        "partitionKeys": [],
    },
    transformation_ctx="CustomerCurated_node1704319136579",
)
