...
CustomerTrusted_node1704319074207 = glueContext.create_dynamic_frame.from_catalog(
    database="test",
    table_name="customer_trusted",
    transformation_ctx="CustomerTrusted_node1704319074207",
)
...
Join_node1704319113800 = Join.apply(
    frame1=CustomerTrusted_node1704319074207,
